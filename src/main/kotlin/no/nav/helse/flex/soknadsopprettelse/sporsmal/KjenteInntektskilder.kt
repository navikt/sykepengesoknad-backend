...
fun kjenteInntektskilderSporsmal(
    ...
    if (andreKjenteArbeidsforhold.isEmpty()) {
        throw IllegalArgumentException(
            "Kan ikke lage spørsmål om kjente inntektskilder uten andre kjente inntektskilder",
        )
    }

    val fjortenDagerFørStartSyketilfelle =
    ...
    return Sporsmal(
        ...
        undersporsmal =
            andreKjenteArbeidsforhold.mapIndexed { idx, arbeidsforhold ->
                Sporsmal(

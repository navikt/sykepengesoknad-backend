...
class SoknadLagrer(
    ...
    fun List<SykepengesoknadDbRecord>.lagre() {
        ...
        val sql = """
INSERT INTO SYKEPENGESOKNAD (ID, SYKEPENGESOKNAD_UUID, SOKNADSTYPE, STATUS, FOM, TOM, OPPRETTET, AVBRUTT_DATO, SYKMELDING_UUID, SENDT_NAV, SENDT_ARBEIDSGIVER, KORRIGERER, KORRIGERT_AV, ARBEIDSGIVER_ORGNUMMER, ARBEIDSGIVER_NAVN, ARBEIDSSITUASJON, START_SYKEFORLOP, SYKMELDING_SKREVET, SYKMELDING_SIGNATUR_DATO, OPPRINNELSE, FNR, EGENMELDT_SYKMELDING, MERKNADER_FRA_SYKMELDING, AVBRUTT_FEILINFO, OPPRETTET_AV_INNTEKTSMELDING, UTENLANDSK_SYKMELDING, EGENMELDINGSDAGER_FRA_SYKMELDING, FORSTEGANGSSOKNAD, TIDLIGERE_ARBEIDSGIVER_ORGNUMMER) 

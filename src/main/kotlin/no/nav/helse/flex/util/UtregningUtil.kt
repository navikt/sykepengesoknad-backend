...
fun inntektJustertForGrunnbeloep(
    ...
    BigDecimal(pensjonsgivendeInntektIKalenderAaret)
...
fun BigDecimal.roundToBigInteger(): BigInteger = this.setScale(0, RoundingMode.HALF_UP).toBigInteger()

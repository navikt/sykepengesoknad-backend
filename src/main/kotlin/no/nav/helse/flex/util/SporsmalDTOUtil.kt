...
fun List<SporsmalDTO>?.getSporsmalMedTagOrNull(tag: String): SporsmalDTO? = this.flatten().firstOrNull { it.tag == tag }
...
fun SykepengesoknadDTO.alleSporsmalOgUndersporsmal(): List<SporsmalDTO> = sporsmal.flatten()

fun SykepengesoknadDTO.getSporsmalMedTagOrNull(tag: String): SporsmalDTO? = sporsmal.getSporsmalMedTagOrNull(tag)

...
class BregDirectClass(
    ...
    val bregUrl = "https://data.brreg.no/"

    fun hentEnhet(virksomhetsnummer: String): Nokkelinfo {
        try {
            val uriBuilder =
                UriComponentsBuilder.fromUriString("$bregUrl/enhetsregisteret/api/enheter/$virksomhetsnummer")

...
import no.nav.syfo.arbeidstaker.gammeltEgenmeldingSpm
import no.nav.syfo.domain.*
import no.nav.syfo.domain.Sykmeldingstype.AKTIVITET_IKKE_MULIG
import no.nav.syfo.domain.Sykmeldingstype.GRADERT

...
import no.nav.syfo.mock.mockUtlandssoknad
...
class SykepengesoknadDAOTest : BaseTestClass() {
    ...
    fun finnMottakerAvSoknad_mottakerErAgOgNav() {
        val soknadId = sykepengesoknadDAO.lagreSykepengesoknad(gammeltFormatOpprettSendtSoknadMedFeriesporsmalSomUndersporsmal()).id
    ...
    fun finnMottakerAvSoknad_soknadIkkeSendt() {
        val soknadId = sykepengesoknadDAO.lagreSykepengesoknad(gammeltFormatOpprettNySoknadMedFeriesporsmalSomUndersporsmal()).id

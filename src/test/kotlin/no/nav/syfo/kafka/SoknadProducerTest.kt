...
import no.nav.syfo.kafka.producer.finnDagerSpartFordiJobbetMerEnnSoknadTilsier
import no.nav.syfo.kafka.producer.finnDagerSpartVedArbeidGjenopptattTidligere

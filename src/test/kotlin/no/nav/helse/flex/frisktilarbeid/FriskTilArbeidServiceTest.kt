...
class FakeFriskTilArbeidSoknadService(
    ...
    override fun opprettSoknad(friskTilArbeidDbRecord: FriskTilArbeidDbRecord) {
        friskTilArbeidRepository.save(friskTilArbeidDbRecord.copy(status = BehandletStatus.BEHANDLET))
    }
}

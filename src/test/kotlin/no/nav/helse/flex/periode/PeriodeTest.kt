...
class PeriodeTest {
    ...
    fun testerUkedager() {
        ...
        // Start og slutt på samme ukedag
        ...
        // Start på fredag og slutt på mandag (inkludert helg)
        val fredagTilMandag =
            Periode(
                of(2024, 10, 25),
                of(2024, 10, 28),
        ...
        // Periode som går over flere uker
        val overFlereUker =
            Periode(
                of(2024, 10, 18),
                of(2024, 10, 31),
    ...
    @Test
    fun testerOverlapp() {
        val fom1 = of(2024, 10, 21)
        val tom1 = of(2024, 10, 27)

        val fom2 = of(2024, 10, 24)
        val tom2 = of(2024, 10, 30)

        val periode1 = Periode(fom1, tom1)
        val periode2 = Periode(fom2, tom2)

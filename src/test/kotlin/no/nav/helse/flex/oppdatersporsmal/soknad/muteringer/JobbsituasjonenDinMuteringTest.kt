...
class JobbsituasjonenDinMuteringTest {
     ...
     */
    private fun opprettStandardSoknad(fom: LocalDate, tom: LocalDate): Sykepengesoknad {
        val soknad = Sykepengesoknad(
            ...
            soknadPerioder = emptyList(), // dummy-perioder
        ...
        return soknad.copy(
            sporsmal = settOppSykepengesoknadFriskmeldtTilArbeidsformidling(

...
class YrkesskadeV2IntegrationTest : BaseTestClass() {
    ...
    @Test
    @Order(1)
    fun `Enabler v2 logikk`() {
        yrkesskadeIndikatorer.yrkesskadeV2 = true
    }

    @Test
    @Order(1)
    fun `Køøer opp yrkesskaderesponse`() {
    ...
    @Test
    @Order(99)
    fun `disabler v2 logikk`() {
        yrkesskadeIndikatorer.yrkesskadeV2 = false
    }
}
